/**
 * Game logic utilities for client-side operations
 */
 ...
 */
export function calculateBaseScore(bid, actualTricks) {
  if (bid === actualTricks) {
 ...
 */
export function calculateScore(bid, actualTricks) {
 ...
 */
export function validateBonusPoints(bid, actualTricks) {
 ...
 */
export function calculateTotalScore(bid, actualTricks, bonusPoints = 0) {
 ...
 */
export function getScorePreview(bid, actualTricks, bonusPoints = 0) {
  const baseScore = calculateBaseScore(bid, actualTricks);
 ...
 */
export function validateScoreInputs(bid, actualTricks) {
  const errors = [];
 ...
 */
export function isPerfectScore(bid, actualTricks) {
  return bid === actualTricks;
}
 ...
 */
export function handleZeroBid(bid, actualTricks) {
  if (bid === 0) {
